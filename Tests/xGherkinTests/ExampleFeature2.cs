...
namespace xGherkinTests
{
    ...
    ")]
    public class PasswordManagement2
    {
        ...
        Scenario("2. Successfull password change")]
        ...
        [PBI("32160"), Bug("42150"), Sprint("1"),
        Scenario("2. Unsuccessfull password change, due to wrong old password")]
